...
use app\models\UserEmpresaSearch;
...
class UserEmpresaController extends Controller
{
    ...
    {
        $searchModel = new UserEmpresaSearch();
     ...
     * @param integer $id
     * @return UserEmpresa the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = UserEmpresa::findOne($id)) !== null) {
            return $model;
        }

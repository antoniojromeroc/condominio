...
--
-- Host: localhost:3306
-- Generation Time: Jul 06, 2019 at 12:38 AM
...
--
-- Table structure for table `cuentavivienda`
--
...
--
-- Dumping data for table `cuentavivienda`
--

INSERT INTO `cuentavivienda` (`id`, `viviendas_id`, `tipoobligaciones_id`, `descripcion`, `mes`, `anio`, `monto`, `fecha_vencimiento`, `monto_faltante`, `cerrada`) VALUES
(1, 2, 1, 'Mensualidad del mes de Enero de 2019', 1, 2019, '2000.00', '2019-01-31', NULL, 0),
(2, 2, 1, 'Mensualidad del mes de Febrero de 2019', 2, 2019, '2000.00', '2019-02-28', NULL, 0);

-- --------------------------------------------------------

--
-- Table structure for table `cuentavivienda_pagosvivienda`
--
...
--
-- Dumping data for table `cuentavivienda_pagosvivienda`
--
...
--
-- Table structure for table `historicoobligaciones`
--
...
--
-- Table structure for table `miembrosdirectiva`
--
...
--
-- Table structure for table `pagosvivienda`
--
...
--
-- Dumping data for table `pagosvivienda`
--
...
(1, 2, '50.00', '000001', 1, 1, '01020527', 'Ruperto', '11056785', '2019-01-01', NULL);
...
--
-- Table structure for table `saldosiniciales`
--
...
--
-- Dumping data for table `saldosiniciales`
--
...
--
-- Table structure for table `saldosmensuales`
--
...
--
-- Dumping data for table `saldosmensuales`
--
...
--
-- Table structure for table `tipoobligaciones`
--
...
--
-- Dumping data for table `tipoobligaciones`
--
...
(3, 'antoniojromeroc', 'antoniojromeroc@gmail.com', '$2y$12$JStaukkXWiUE/g2T7Q.7DuUH/m10rOLp0yO.JaC7GXTk6Qer3OD4S', 'B-W9DD4iODzh1iZlujTlcJNCopHja12w', 1558566627, NULL, NULL, '127.0.0.1', 1558565668, 1558565668, 0, 1562210708);
...
--
-- Table structure for table `viviendas_personas`
--
...
--
-- Indexes for table `cuentavivienda`
--
...
--
-- Indexes for table `cuentavivienda_pagosvivienda`
--
...
--
-- Indexes for table `historicoobligaciones`
--
...
--
-- Indexes for table `juntacondominio`
--
...
--
-- Indexes for table `miembrosdirectiva`
--
...
--
-- Indexes for table `pagosvivienda`
--
...
--
-- Indexes for table `saldosiniciales`
--
ALTER TABLE `saldosiniciales`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `saldosmensuales`
--
...
--
-- Indexes for table `tipoobligaciones`
--
...
--
-- Indexes for table `viviendas_personas`
--
...
--
-- AUTO_INCREMENT for table `cuentavivienda`
--
ALTER TABLE `cuentavivienda`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `cuentavivienda_pagosvivienda`
--
ALTER TABLE `cuentavivienda_pagosvivienda`
...
--
-- AUTO_INCREMENT for table `historicoobligaciones`
--
ALTER TABLE `historicoobligaciones`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
-- AUTO_INCREMENT for table `juntacondominio`
--
ALTER TABLE `juntacondominio`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `miembros`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `miembrosdirectiva`
--
ALTER TABLE `miembrosdirectiva`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `operacion`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `pagosvivienda`
--
ALTER TABLE `pagosvivienda`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
ALTER TABLE `rol`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `saldosiniciales`
--
ALTER TABLE `saldosiniciales`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `saldosmensuales`
--
ALTER TABLE `saldosmensuales`
...
ALTER TABLE `social_account`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `tipoobligaciones`
--
ALTER TABLE `tipoobligaciones`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
ALTER TABLE `user`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `user_bk`
--
ALTER TABLE `user_bk`
...
ALTER TABLE `viviendas`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `viviendas_personas`
--
ALTER TABLE `viviendas_personas`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
-- Constraints for table `cuentavivienda`
--
ALTER TABLE `cuentavivienda`
...
--
-- Constraints for table `cuentavivienda_pagosvivienda`
--
ALTER TABLE `cuentavivienda_pagosvivienda`
...
--
-- Constraints for table `pagosvivienda`
--
ALTER TABLE `pagosvivienda`
...
--
-- Constraints for table `user_bk`
--
ALTER TABLE `user_bk`
  ADD CONSTRAINT `fk_user_rol` FOREIGN KEY (`rol_id`) REFERENCES `rol` (`id`);

--
-- Constraints for table `user_empresa`
--
ALTER TABLE `user_empresa`
...
--
-- Constraints for table `viviendas_personas`
--
ALTER TABLE `viviendas_personas`
